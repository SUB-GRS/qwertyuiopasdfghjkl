...
module.exports = function (app) {
    app.get('/maker/totobrut', async (req, res) => {
        const { url } = req.query;
        const fixedPrompt = `Ubah dada karakter dalam gambar ini agar terlihat lebih menonjol. Jangan ubah pakaian atau atribut lain. Fokus hanya pada bagian dan bentuk dada.`;
