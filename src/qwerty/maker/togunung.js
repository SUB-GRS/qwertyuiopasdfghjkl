...
module.exports = function (app) {
    app.get('/maker/togunung', async (req, res) => {
        const { url } = req.query;
        const fixedPrompt = `Ultra realistic cinematic documentary-style mountain summit scene at Mount Slamet, a person sitting casually on rocky volcanic ground wearing full adventure hiking outfit (outdoor jacket, hiking pants, sturdy boots), backpack placed beside them, green summit sign board with “MT. SLAMET 3428 MDPL” positioned in front of their legs. Natural harsh sunlight, authentic textures, wind subtly moving hair and jacket, travel expedition photography style. Match facial structure, skin tone, hairstyle, and proportions closely to the uploaded reference image while keeping it suitable for all genders.`; 
