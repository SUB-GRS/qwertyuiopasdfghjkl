...
module.exports = function (app) {
    app.get('/maker/tosad', async (req, res) => {
        const { url } = req.query;
        const fixedPrompt = `Anda adalah ahli manipulasi ekspresi wajah digital.
Tugas: Ubah ekspresi wajah subjek dalam foto ini menjadi tampak sangat sedih dan melas.
Instruksi:
1. Identifikasi seluruh area wajah: alis, mata, pipi, mulut, dan dagu.
2. Turunkan sudut bibir ke bawah (frown), tambahkan lipatan sedih di sekitar mulut.
3. Buat alis membentuk kurva sedih (sudut dalam alis terangkat ke atas).
4. Tambahkan efek mata berkaca-kaca atau sedikit merah di tepi kelopak mata.
5. Tambahkan efek pipi sedikit memerah seperti habis menangis.
6. Pertahankan warna kulit, pencahayaan, dan latar belakang asli.
Output: Foto realistis dengan ekspresi wajah sangat sedih dan melas namun tetap natural.`;
